"""Auto-generated runner for the disclosure_check check. Loads
checks/disclosure_check.yaml and runs it against CLI-supplied params -- edit
...
CHECK_FILE = Path(__file__).parent / "checks" / "disclosure_check.yaml"
